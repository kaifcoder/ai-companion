            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    This is how your Ai will be called
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    Write a short description about your Ai
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="col-span-2 md:col-span-1">
                ...
                <FormDescription>
                  Write a brief instructions for your Ai in 200 characters
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem className="col-span-2 md:col-span-1">
                ...
                <FormControl>
                  <Textarea
                    ...
                    rows={8}
                    disabled={isLoading}
                    placeholder={`Write a brief example conversation \n\nExample: \n${SEED_CHAT}`}
                    {...field}
                  />
                </FormControl>
                <FormDescription>
